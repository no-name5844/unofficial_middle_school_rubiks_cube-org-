...
files = [
    ('xssz魔方非官方组织临时章程-20260626-2246.md', '章程'),
    ('全体成员会议工作细则-20260627.md', '细则'),
    ('特殊身份临时细则-20260623.md', '细则'),
    ('监察委员会调查程序临时细则-20260627.md', '细则'),
    ('常任委员会运作临时细则-20260627.md', '细则'),
    ('历史管理委员会临时细则-20260627.md', '细则'),
    ('经费管理委员会临时细则-20260627.md', '细则'),
]
